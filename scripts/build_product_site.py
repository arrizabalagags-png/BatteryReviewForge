...
def main() -> None:
    ...
    for name, (title, description, body) in PAGES.items():
        js = f'<script src="start.js?v={VERSION}-guide2" defer></script>' if name == "start.html" else ""
