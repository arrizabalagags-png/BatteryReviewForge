...
下载并解压 [完整源码与安装包](https://github.com/arrizabalagags-png/BatteryReviewForge/releases/download/v0.6.1/BatteryReviewForge-v0.6.1.zip)。看到 `skills/`、`install.ps1` 和 `install.sh` 三项后，再按自己的软件做以下一步。
